...
<form action="insertm">
<b>ID</b> <input type="text" name="id" style="background-color:HoneyDew;"><br><br>
<b>Name</b><input type="text" name="name" style="background-color:HoneyDew;"><br><br>
<b>Price</b><input type="text" name="price" style="background-color:HoneyDew;"><br><br>
...
<form action="getmsg">
<input type="submit" value="User Messages list">
</form>
</div>
<div id="bg-wrap">
