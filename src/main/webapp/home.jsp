                    ...
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                ...
                                <h2><a href="single-product.html">Combiflam</a></h2>
                                
                                <div class="product-carousel-price">
                                    <ins>$7.00</ins> <del>$17.00</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                            ...
                            <div class="single-product">
                                ...
                                <h2><a href="single-product.html">Zerodal-SP</a></h2>

                                <div class="product-carousel-price">
                                    <ins>$18.00</ins> <del>$25.00</del>
                                </div>                            
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                            ...
                            <div class="single-product">
                                ...
                                <h2><a href="single-product.html">Dolo-650</a></h2>
